...
import { Sparkles, MapPin, Users, RefreshCw, Download, ArrowRight } from 'lucide-react';
        ...
        {generatedTopic && (
          <div className="bg-white rounded-3xl shadow-sm p-6 animate-fade-in">
            ...
            <button 
              ...
              className="w-full mt-6 bg-blue-600 text-white p-4 rounded-2xl hover:bg-blue-700 transition-colors font-medium flex items-center justify-center gap-2"
            >
